...
* Under `modem:`
  ...
  * Under `uart:` change the `port:` "/dev/DVMV24". Be sure to add the [udev rules](https://github.com/tsawyer/dvm-project-notes/blob/main/config/99_dvmv24.rules file) to `/etc/udev/rules.d`.
